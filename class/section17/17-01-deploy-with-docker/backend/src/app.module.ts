...
import { PointsTransactionsModule } from 'src/apis/pointsTransactions/pointsTransactions.module';
import { PaymentsMoudle } from 'src/apis/payments/payments.module';
import { FilesModule } from 'src/apis/files/files.module';
...
@Module({
  imports: [
    ...
    GraphQLModule.forRoot<ApolloDriverConfig>({
      ...
      // formatError: (error) => { // 에러건에 대한 조작이 더 필요한 경우 사용하면 좋다.
      //   console.log('에러송신');
      //   console.log(error);
      //   return error;
      // },
